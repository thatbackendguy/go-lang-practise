...
func main() {
	...
	// uint8	the set of all unsigned 1 byte - 8-bit integers (0 to 255)
	// uint16	the set of all unsigned 2 byte - 16-bit integers (0 to 65535)
	// uint32	the set of all unsigned 4 byte - 32-bit integers (0 to 4294967295)
	// uint64	the set of all unsigned 8 byte - 64-bit integers (0 to 18446744073709551615)
